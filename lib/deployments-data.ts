...
export const DEPLOYMENTS: Deployment[] = [
  ...
  { id:"tusd-classic",name:"TUSD on Ethereum Classic",      chain:"Classic",  chainShort:"ETC",  chainColor:"#34fa99", chainTextColor:"text-[#1a1a1a]", chainId:61,       isPlaceholder:true,  stablecoin:"TUSD",  equityCoin:"TEQT",  reserveRatio:280, totalReserve:"$5.12M",  stableSupply:"600K",  equitySupply:"15K", equityLeverage:"2.8×",  equityYield:7.4, tvl:"$2.15M",  status:"healthy", reserveAsset:"ETC", pegAsset:"USD" },
  { id:"tusd-base",   name:"TUSD on Base",                  chain:"Base",     chainShort:"BASE", chainColor:"#0052ff", chainTextColor:"text-white",       chainId:8453,     isPlaceholder:true,  stablecoin:"TUSD",  equityCoin:"TEQT",  reserveRatio:315, totalReserve:"$8.45M",  stableSupply:"2.6M",  equitySupply:"85K", equityLeverage:"3.15×", equityYield:5.2, tvl:"$6.21M",  status:"healthy", reserveAsset:"ETH", pegAsset:"USD" },
];
