...
- **Formatting**: We use Prettier/ESLint. Ensure your code is properly formatted before committing.
...
1. **Fork the repo** and create your branch from `main` (`git checkout -b feature/my-new-feature`).
